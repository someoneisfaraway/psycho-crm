// src/components/finances/ExpectedRevenueModal.tsx
...
const ExpectedRevenueModal: React.FC<ExpectedRevenueModalProps> = ({
  isOpen,
  onClose,
  userId,
  initialStartDate,
  ...
  const fetchExpectedRevenue = async () => {
    ...
    try {
      ...
      console.error('Ошибка загрузки ожидаемого дохода:', err);
    ...
    <div className="fixed inset-0 bg-overlay flex items-center justify-center p-4 z-40">
      <div className="bg-bg-primary rounded-lg shadow-xl w-full max-w-2xl mx-4">
        <div className="flex items-center justify-between px-6 py-4 border-b">
          <h2 className="text-xl font-semibold text-gray-900">Ожидаемый доход</h2>
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              <div className="bg-blue-50 rounded-lg p-4">
                <div className="text-sm text-gray-600">Итого ожидается</div>
...
export default ExpectedRevenueModal;
