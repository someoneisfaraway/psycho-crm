...
// import { useAuth } from '../../contexts/AuthContext'; // удалено: не используется
import type { Client } from '../../types/database';
import ClientCard from './ClientCard';
// import { Button } from '../ui/Button'; // удалено: не используется
// import { Plus, Search } from 'lucide-react'; // удалено: не используется
// import { getClients } from '../../api/clients'; // удалено: не используется
...
const ClientsList: React.FC<ClientsListProps> = ({
  ...
  return (
    <div>
      {/* Удалена верхняя панель с поиском и кнопкой добавления */}
