...
const ClientsList: React.FC<ClientsListProps> = ({
  ...
  if (error) {
    return (
      <div className="card bg-status-error-bg border border-status-error-border p-4">
        <div className="flex">
    ...
    <div>
      ...
      {filteredClients.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h3 className="mt-2 text-sm font-medium text-text-primary">Клиенты не найдены</h3>
